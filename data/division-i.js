...
const DIV_I_PLAYERS = [
  { name:'T. Karthick',           team:'SATCH', gender:'M', age:35, role:'Captain', gamesPlayed:8, wins:8 },
  { name:'G. Prasath',            team:'SATCH', gender:'M', age:29, role:'Player',  gamesPlayed:8, wins:8 },
  ...
  { name:'G Sendhur',             team:'SATCH', gender:'M', age:16, role:'Player',  gamesPlayed:8, wins:8 },
  { name:'B.R. Viswak',           team:'SATCH', gender:'M', age:13, role:'Player',  gamesPlayed:8, wins:8 },
  { name:'Ashwin Krishna M.R',    team:'SATCH', gender:'M', age:12, role:'Player',  gamesPlayed:2, wins:2 },
  { name:'Theneeshwaran M',       team:'SATCH', gender:'M', age:13, role:'Player',  gamesPlayed:8, wins:8 },
  { name:'Nithik M.K',            team:'SATCH', gender:'M', age:12, role:'Player',  gamesPlayed:2, wins:2 },
  { name:'S K Nithin',            team:'SATCH', gender:'M', age:16, role:'Player',  gamesPlayed:4, wins:4 },
  { name:'Sarankumar Sathasivam', team:'TTOTS', gender:'M', age:31, role:'Captain', gamesPlayed:8, wins:8 },
  { name:'Sivakumar Eswaran',     team:'TTOTS', gender:'M', age:50, role:'Player',  gamesPlayed:null, wins:null },
  { name:'Mahita Karthik',        team:'TTOTS', gender:'F', age:14, role:'Player',  gamesPlayed:6, wins:6 },
  { name:'Pragathishwar Aan',     team:'TTOTS', gender:'M', age:21, role:'Player',  gamesPlayed:7, wins:6 },
  { name:'Adith Balasubramaniam', team:'TTOTS', gender:'M', age:16, role:'Player',  gamesPlayed:8, wins:8 },
  { name:'Varun Satishkumar',     team:'TTOTS', gender:'M', age:11, role:'Player',  gamesPlayed:4, wins:4 },
  { name:'Shivani Sivakumar',     team:'TTOTS', gender:'F', age:14, role:'Player',  gamesPlayed:8, wins:8 },
  { name:'Juanishbibian C',       team:'TTOTS', gender:'M', age:16, role:'Player',  gamesPlayed:7, wins:6 },
  { name:'Monish',                team:'STARS', gender:'M', age:40, role:'Captain', gamesPlayed:8, wins:6 },
  { name:'Kishore',               team:'STARS', gender:'M', age:41, role:'Player',  gamesPlayed:7, wins:5 },
  { name:'Ramesh',                team:'STARS', gender:'M', age:58, role:'Player',  gamesPlayed:2, wins:1 },
  { name:'Palaniappan',           team:'STARS', gender:'M', age:42, role:'Player',  gamesPlayed:6, wins:4 },
  { name:'Chandrasekar',          team:'STARS', gender:'M', age:59, role:'Player',  gamesPlayed:1, wins:1 },
  { name:'Suryaa',                team:'STARS', gender:'M', age:14, role:'Player',  gamesPlayed:5, wins:4 },
  { name:'Harin',                 team:'STARS', gender:'M', age:15, role:'Player',  gamesPlayed:null, wins:null },
  { name:'Revathi',               team:'STARS', gender:'F', age:40, role:'Player',  gamesPlayed:5, wins:3 },
  ...
  { name:'Shankar V',             team:'STARS', gender:'M', age:65, role:'Player',  gamesPlayed:8, wins:6 },
  { name:'Shyama Kelath',         team:'TGLO',  gender:'F', age:36, role:'Captain', gamesPlayed:8, wins:5 },
  { name:'Thirumalai Nambi',      team:'TGLO',  gender:'M', age:41, role:'Player',  gamesPlayed:4, wins:2 },
  { name:'Rajarathnam',           team:'TGLO',  gender:'M', age:42, role:'Player',  gamesPlayed:6, wins:4 },
  ...
  { name:'Naveen Kumar',          team:'TGLO',  gender:'M', age:29, role:'Player',  gamesPlayed:7, wins:3 },
  { name:'Arjun Visratej',        team:'TGLO',  gender:'M', age:29, role:'Player',  gamesPlayed:6, wins:1 },
  { name:'Siddaarth Malay',       team:'TGLO',  gender:'M', age:29, role:'Player',  gamesPlayed:6, wins:3 },
  { name:'Sampath Gnanaraja',     team:'RAIL',  gender:'M', age:53, role:'Captain', gamesPlayed:8, wins:4 },
  { name:'Saravanakumar',         team:'RAIL',  gender:'M', age:37, role:'Player',  gamesPlayed:8, wins:4 },
  { name:'Vivinraja',             team:'RAIL',  gender:'M', age:20, role:'Player',  gamesPlayed:7, wins:5 },
  { name:'Sasikumar',             team:'RAIL',  gender:'M', age:51, role:'Player',  gamesPlayed:7, wins:4 },
  { name:'Louis Paal',            team:'RAIL',  gender:'M', age:58, role:'Player',  gamesPlayed:8, wins:4 },
  { name:'Sugunan',               team:'RAIL',  gender:'M', age:57, role:'Player',  gamesPlayed:8, wins:6 },
  ...
  { name:'Vigneswar',             team:'GNEST', gender:'M', age:32, role:'Captain', gamesPlayed:8, wins:2 },
  { name:'Raghavendr Ban',        team:'GNEST', gender:'M', age:36, role:'Player',  gamesPlayed:null, wins:null },
  { name:'Gopala Krishnan',       team:'GNEST', gender:'M', age:43, role:'Player',  gamesPlayed:9, wins:4 },
  { name:'Gunaseel',              team:'GNEST', gender:'M', age:29, role:'Player',  gamesPlayed:7, wins:3 },
  { name:'Vijayaraju G',          team:'GNEST', gender:'M', age:30, role:'Player',  gamesPlayed:5, wins:2 },
  ...
  { name:'Murali Kumar D',        team:'GNEST', gender:'M', age:29, role:'Player',  gamesPlayed:9, wins:3 },
  { name:'Giulia Bosco',          team:'CBE',   gender:'F', age:47, role:'Captain', gamesPlayed:8, wins:4 },
  { name:'Danalakshmi Govindrajann',team:'CBE', gender:'F', age:44, role:'Player',  gamesPlayed:1, wins:0 },
  { name:'Sangeet Bagaria',       team:'CBE',   gender:'M', age:49, role:'Player',  gamesPlayed:5, wins:3 },
  ...
  { name:'Gaurav Kapoor',         team:'CBE',   gender:'M', age:37, role:'Player',  gamesPlayed:6, wins:5 },
  ...
  { name:'Raghuram Murugesan',    team:'CBE',   gender:'M', age:55, role:'Player',  gamesPlayed:7, wins:4 },
  { name:'Joseph J Chakola',      team:'CBE',   gender:'M', age:40, role:'Player',  gamesPlayed:6, wins:3 },
  { name:'Yunus Abbas Vagh',      team:'CBE',   gender:'M', age:43, role:'Player',  gamesPlayed:7, wins:6 },
  { name:'Varun Ravichandran',    team:'CBE',   gender:'M', age:37, role:'Player',  gamesPlayed:5, wins:1 },
  { name:'Murugesan M',           team:'CHAMPS',gender:'M', age:49, role:'Captain', gamesPlayed:7, wins:2 },
  { name:'Abdul Rahiman K',       team:'CHAMPS',gender:'M', age:53, role:'Player',  gamesPlayed:9, wins:5 },
  { name:'T Karthikeyan Sudhakar',team:'CHAMPS',gender:'M', age:55, role:'Player',  gamesPlayed:6, wins:0 },
  { name:'Dhivya Kanakabala B',   team:'CHAMPS',gender:'F', age:42, role:'Player',  gamesPlayed:4, wins:1 },
  { name:'Gnanasekaran S',        team:'CHAMPS',gender:'M', age:43, role:'Player',  gamesPlayed:9, wins:5 },
  { name:'Senthilkumar T',        team:'CHAMPS',gender:'M', age:43, role:'Player',  gamesPlayed:7, wins:1 },
  { name:'Jeevaraj A',            team:'CHAMPS',gender:'M', age:54, role:'Player',  gamesPlayed:9, wins:2 },
  { name:'Natarajan',             team:'CHAMPS',gender:'M', age:80, role:'Player',  gamesPlayed:1, wins:0 },
  { name:'Pragadeesan T',         team:'SNS',   gender:'M', age:47, role:'Captain', gamesPlayed:7, wins:5 },
  { name:'Sai Sankar Mohana Kesavan',team:'SNS',gender:'M', age:37, role:'Player',  gamesPlayed:5, wins:1 },
  { name:'Jeganath R',            team:'SNS',   gender:'M', age:43, role:'Player',  gamesPlayed:4, wins:1 },
  { name:'Neelesh Lingaraj',      team:'SNS',   gender:'M', age:40, role:'Player',  gamesPlayed:4, wins:2 },
  { name:'Subramanian',           team:'SNS',   gender:'M', age:47, role:'Player',  gamesPlayed:null, wins:null },
  { name:'Rajesh K',              team:'SNS',   gender:'M', age:40, role:'Player',  gamesPlayed:8, wins:4 },
  { name:'Prabhakaran V',         team:'SNS',   gender:'M', age:46, role:'Player',  gamesPlayed:7, wins:2 },
  { name:'Harsha M K',            team:'SNS',   gender:'F', age:15, role:'Player',  gamesPlayed:6, wins:2 },
  { name:'Jaswanth M K',          team:'SNS',   gender:'M', age:12, role:'Player',  gamesPlayed:7, wins:1 },
  ...
  { name:'Pani Ramasami',         team:'KING',  gender:'M', age:52, role:'Captain', gamesPlayed:7, wins:3 },
  { name:'David Simon',           team:'KING',  gender:'M', age:50, role:'Player',  gamesPlayed:3, wins:1 },
  { name:'Kulasekaran J',         team:'KING',  gender:'M', age:48, role:'Player',  gamesPlayed:5, wins:0 },
  { name:'Aashi Manuel Charles',  team:'KING',  gender:'M', age:26, role:'Player',  gamesPlayed:5, wins:0 },
  { name:'Damien Stany',          team:'KING',  gender:'M', age:10, role:'Player',  gamesPlayed:1, wins:0 },
  { name:'Sandra Christine',      team:'KING',  gender:'F', age:20, role:'Player',  gamesPlayed:4, wins:0 },
  { name:'Joseph Stany',          team:'KING',  gender:'M', age:42, role:'Player',  gamesPlayed:1, wins:0 },
  { name:'Angel Christina (Tina)',team:'KING',  gender:'F', age:21, role:'Player',  gamesPlayed:5, wins:0 },
  { name:'Samyukta Y',            team:'KING',  gender:'F', age:12, role:'Player',  gamesPlayed:6, wins:1 },
  { name:'Babu',                  team:'KING',  gender:'M', age:50, role:'Player',  gamesPlayed:3, wins:1 }
];

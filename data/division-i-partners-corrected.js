const DIV_I_PARTNERS = {
  ...
  'Harsha M K': [['Jaswanth M K',5],['Pragadeesan T',1],['Neelesh Lingaraj',1]],
  'Jaswanth M K': [['Harsha M K',5],['Rajesh K',1],['Pragadeesan T',1],['Prabhakaran V',1]],
  'Jeganath R': [['Rajesh K',1],['Sai Sankar Mohana Kesavan',3],['Prabhakaran V',1]],
  'Neelesh Lingaraj': [['Prabhakaran V',1],['Pragadeesan T',1],['Harsha M K',1],['Sai Sankar Mohana Kesavan',1]],
  'Prabhakaran V': [['Rajesh K',3],['Sai Sankar Mohana Kesavan',2],['Neelesh Lingaraj',1],['Jaswanth M K',1],['Jeganath R',1]],
  'Pragadeesan T': [['Rajesh K',4],['Harsha M K',1],['Neelesh Lingaraj',1],['Jaswanth M K',1]],
  'Rajesh K': [['Pragadeesan T',4],['Prabhakaran V',3],['Jaswanth M K',1],['Jeganath R',1]],
  'Sai Sankar Mohana Kesavan': [['Jeganath R',3],['Prabhakaran V',2],['Neelesh Lingaraj',1]],
  'Abhinnav': [['Kishore',1]],
  'Chandrasekar': [['Monish',2]],
  'Kishore': [['Senthil',3],['Palaniappan',1],['Suryaa',1],['Monish',1],['Abhinnav',1]],
  'Monish': [['Palaniappan',3],['Suryaa',2],['Chandrasekar',2],['Kishore',1],['Shankar V',1]],
  'Palaniappan': [['Monish',3],['Kishore',1],['Senthil',1],['Ramesh',1]],
  'Ramesh': [['Shankar V',2],['Palaniappan',1]],
  'Revathi': [['Shankar V',4],['Suryaa',1]],
  'Senthil': [['Kishore',3],['Suryaa',1],['Shankar V',1],['Palaniappan',1]],
  'Shankar V': [['Revathi',4],['Ramesh',2],['Senthil',1],['Suryaa',1],['Monish',1]],
  'Suryaa': [['Monish',2],['Senthil',1],['Kishore',1],['Shankar V',1],['Revathi',1]],

...
const DIV_H_PLAYERS = [
  // SNS - D
  { name:'SATHISH KUMAR',                    team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:8 },
  { name:'Sathyaseelan',                     team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:8 },
  { name:'KRISHNASAAMY.M',                   team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:4 },
  { name:'Jayachandran J',                   team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:5 },
  { name:'Penmetsha Sita Ram Rohit Verma',   team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:5 },
  { name:'Senthilnathan CR',                 team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:5, wins:5 },
  { name:'Prabhakaran C',                    team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'Pushparaj',                        team:'SNS-D',  gender:null, age:null, role:'Player', gamesPlayed:2, wins:1 },
  // PSG Tech
  { name:'Adhitya R',                        team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:7, wins:7 },
  { name:'Abhishek K A',                     team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:7, wins:6 },
  { name:'Mehul Dinesh',                     team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:5 },
  { name:'Sukesh Netaji M A',               team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:5 },
  { name:'Aatish Srinivasan',               team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:4 },
  { name:'Viswa D K',                        team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:3 },
  { name:'BHUVANESH D',                      team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:3, wins:2 },
  { name:'Karin Senapati R',                team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'NAVANEETH M',                      team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:1, wins:0 },
  { name:'SAKTHIVEL M',                      team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:1, wins:1 },
  { name:'Richard Samuel D',                team:'PSG',    gender:null, age:null, role:'Player', gamesPlayed:1, wins:1 },
  // ANUSHAM - B
  { name:'Vignesh K',                        team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:7 },
  { name:'Ganesh Pattiappan',                team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:7 },
  { name:'Charan Ganesh',                    team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:6 },
  { name:'RINESH AARYA',                     team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:3 },
  { name:'Karthikeyan UKPM',                team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:5 },
  { name:'Lakshan N',                        team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'Nithinraj PG',                     team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'Dharani Deepan M',                team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:1, wins:0 },
  { name:'Dakshin Eshwar P',                team:'ANU-B',  gender:null, age:null, role:'Player', gamesPlayed:1, wins:0 },
  // RS PURAM - A
  { name:'Ravi.N',                           team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:7, wins:5 },
  { name:'Rajendran',                        team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:7, wins:5 },
  { name:'Srinivasan C. V',                 team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'Arunkumar G',                      team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:4 },
  { name:'Venugopal C.V',                   team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'Prakash. R',                       team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:3 },
  { name:'Vishwaroop',                       team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:3, wins:0 },
  { name:'Ramachandran Dr',                 team:'RSP',    gender:null, age:null, role:'Player', gamesPlayed:3, wins:1 },
  // G.P.T.C - C
  { name:'SAI SIMIRITHI',                   team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:6, wins:4 },
  { name:'GOKUL THANGAM',                   team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:5, wins:3 },
  { name:'VIKRAM DG',                        team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:4, wins:2 },
  { name:'SAMPATHKUMAR AJAY HEMANTH',       team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:4, wins:2 },
  { name:'YOKESH R',                         team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:3, wins:2 },
  { name:'AARAV M VELAYUTHAM',              team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:3, wins:2 },
  { name:'S P Suresh Kumar',                team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:3, wins:1 },
  { name:'Prabhu Anand R',                  team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:3, wins:1 },
  { name:'RANGARAJ LAKSHMANAN',             team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'AKILADITHYA',                     team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'RAJENDRAN N',                      team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:2, wins:0 },
  { name:'JERRY',                            team:'GPTC-C', gender:null, age:null, role:'Player', gamesPlayed:2, wins:0 },
  // ANNUR - C(V2 SPORTS)
  { name:'LAKSHMI VISHNU',                  team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:5 },
  { name:'YOGESH KUMAR',                    team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:4 },
  { name:'RANSLEY ROGER',                   team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:3 },
  { name:'SELVAKUMAR',                       team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'Kiruthick',                        team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'Gnaalan',                          team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'Akarshana',                        team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:3, wins:1 },
  { name:'Samyuktha',                        team:'ANNUR',  gender:null, age:null, role:'Player', gamesPlayed:3, wins:2 },
  // ACTC - B
  { name:'Raul Gujjan R R',                 team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:7, wins:5 },
  { name:'VIJAYAKUMAR G',                   team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'KARTHICK SHANKAR',                team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:5, wins:3 },
  { name:'ARAVINDH P',                      team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'SRIDHAR M',                        team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:5, wins:4 },
  { name:'GOWRI SHANKAR',                   team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:5, wins:0 },
  { name:'MITHRAN',                          team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:4, wins:3 },
  { name:'JEYAKUMAR R',                     team:'ACTC-B', gender:null, age:null, role:'Player', gamesPlayed:2, wins:0 },
  // TIRUPUR - B
  { name:'S.CHANDRU',                        team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:4 },
  { name:'R.KARTHIKAA',                      team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:4 },
  { name:'AYYASSUWAMY',                      team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'K.VIVEKANANDA',                   team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:5, wins:1 },
  { name:'S.SUKUMARAN',                      team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:4, wins:1 },
  { name:'SIVASUBRAMANIAM',                  team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:3, wins:0 },
  { name:'CHANDRASEKARAN C',                team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:3, wins:1 },
  { name:'THIYAGEARAJAN T',                 team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:2, wins:2 },
  { name:'LAKSHAMANAN S',                   team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:1, wins:1 },
  { name:'HEMAVARSHINI S J',                team:'TIR-B',  gender:null, age:null, role:'Player', gamesPlayed:1, wins:0 },
  // KGR - D
  { name:'GOPALAKRISHNAN NALLAIYAN',        team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:8, wins:4 },
  { name:'KAVINKUMAR',                       team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:7, wins:3 },
  { name:'K A KOWSIYAN',                    team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:2 },
  { name:'SARAVANA PRASAD',                 team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:6, wins:0 },
  { name:'SHAHUL HAMEED',                   team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:5, wins:1 },
  { name:'SATHISHKUMAR SHANKAR',            team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:4, wins:0 },
  { name:'SATHISH KUMAR M',                 team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:4, wins:0 },
  { name:'JEEVAN DIVAKAR K',               team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:4, wins:1 },
  { name:'KUMAR D',                          team:'KGR-D',  gender:null, age:null, role:'Player', gamesPlayed:2, wins:1 },
  // FALCON
  { name:'BALA',                             team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:7, wins:1 },
  { name:'SRIRAM',                           team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:6, wins:0 },
  { name:'EZEKIEL I',                       team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'R S ROSHAN',                      team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:5, wins:3 },
  { name:'VIJAYARAMAMOORTHY',               team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:5, wins:1 },
  { name:'KRISHNARAJ M',                    team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:4, wins:1 },
  { name:'PRABHU',                           team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:4, wins:0 },
  { name:'ANINDITHA',                        team:'FALCON', gender:null, age:null, role:'Player', gamesPlayed:3, wins:2 },
  // CS ACADEMY - C
  { name:'YOGAN',                            team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:6, wins:1 },
  { name:'RITHVIK',                          team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:6, wins:0 },
  { name:'ARYA',                             team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:2 },
  { name:'NARAIN',                           team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:5, wins:0 },
  { name:'SANKRIT',                          team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:1 },
  { name:'YUKTI',                            team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:1 },
  { name:'MAHIZHINI',                        team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:4, wins:0 },
  { name:'VIGNESH',                          team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:2, wins:1 },
  { name:'DIYA',                             team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:2, wins:0 },
  { name:'KISHORE',                          team:'CSA',    gender:null, age:null, role:'Player', gamesPlayed:2, wins:0 }
];
